...
data_file = pd.read_csv('../Dataset/signals_stats.csv',sep=';',decimal='.', index_col=0)
...
df_pears.to_csv('signal_stats_pearson.csv',sep=';',decimal='.')
df_spear = pd.DataFrame(spearman)
df_spear['stat'] = 'Spearman'
df_spear.to_csv('signal_stats_spearman.csv',sep=';',decimal='.')
df = pd.concat([df_pears, df_spear])
df.to_csv('signal_stats_combined.csv',sep=';',decimal='.')